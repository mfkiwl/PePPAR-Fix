...
| **fix set** | The SVs whose integer ambiguities contribute to the current position solution.  Partitioned into short-term and long-term members.  See `docs/sv-lifecycle-and-pfr-split.md`. |
