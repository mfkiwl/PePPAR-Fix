#!/usr/bin/env python3
"""Plot 2 from visual-stories.md: PHC PPS Time Error and TDEV Measurement.
...
Usage:
    python3 tools/phc_pps_time_error_tdev.py \
        ...
        -o plots/phc-pps-time-error-tdev.html
"""
...
def main():
    ...
    ap = argparse.ArgumentParser(
        description="Plot 2: PHC PPS Time Error and TDEV Measurement")
    ...
    ap.add_argument("-o", "--output",
                    default="plots/phc-pps-time-error-tdev.html")
    args = ap.parse_args()
    ...
    fig.update_layout(
        title=dict(
            text=(
                'PHC PPS Time Error and TDEV Measurement<br>'
                '<sub>Both i226 and E810 EXTTS have ~8 ns effective resolution '
                '(125 MHz F9T clock period).<br>'
                'Purple shading: actual F9T jitter hidden by E810 quantization '
