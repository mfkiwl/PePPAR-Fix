				       ...
				       struct ptp_clock_request *rq, int on)
{
	...
	case PTP_CLK_REQ_EXTTS:
		 ...
		 * requirement. The I226 hardware on TimeHAT only produces
		 * clean rising-edge PPS signals.
		 */
	...
	case PTP_CLK_REQ_PEROUT:
		 ...
		 * When testptp -p 1000000000 is used, ns = period/2 = 500000000.
		 * Without this fix, 1PPS would incorrectly use frequency mode
		 * producing a 1Hz square wave instead of proper PPS pulses.
		 */
